...
namespace BuddySDK
{
    public class UserListCollection : BuddyCollectionBase<UserList>
    {
        ...
        public async Task<BuddyResult<UserList>> AddAsync(string name,
            BuddyGeoLocation location = null, string tag = null, BuddyPermissions readPermissions = BuddyPermissions.User, BuddyPermissions writePermissions = BuddyPermissions.User)
        {
